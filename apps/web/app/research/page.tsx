...
export default function ResearchPage() {
  return <main id="main-content" className="shell">
    ...
    <section className="section"><div className="notice"><strong>Research integrity:</strong> Phase 2.4 adds edition-witness metadata, sentence-level alignment review records, richer starter morphology provenance, citation profiles, and a browser-local research review queue. These features do not claim a complete critical edition, complete morphology engine, or authenticated scholarly verification. Future imports must retain source, edition, license, checksum, provenance, reviewer, and audit metadata.</div></section>
  </main>;
}
